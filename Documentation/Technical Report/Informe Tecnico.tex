...
\hline
Name & string & Nombre del hechicero (requerido) \\
\hline
...
La capa de Núcleo (Core) contiene las entidades del dominio, enumeraciones y reglas de negocio fundamentales. Esta capa no tiene dependencias externas y define los contratos que las demás capas deben cumplir.
...
La fase de Planificación estableció el alcance del proyecto, identificó los actores del sistema y definió los requisitos funcionales de alto nivel. Durante esta fase se elaboró el documento de visión y se priorizaron las funcionalidades según el valor de negocio.
...
La fase de Desarrollo implementó los requisitos siguiendo la arquitectura de cinco capas definida. El desarrollo procede por iteraciones, donde cada iteración entrega funcionalidad completa y probada. Se aplicaron principios SOLID y se mantuvieron pruebas automatizadas.
